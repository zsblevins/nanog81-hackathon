...
associated interface
  """
  __slots__ = ('_path_helper', '_extmethods', '__id','__interface','__subinterface','__associated_address_families',)
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /network_instances/network_instance/interfaces/interface/state/id (string)
...
as a free-text string
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /network_instances/network_instance/interfaces/interface/state/id (string)
