...
packets matching the rule.
  """
  __slots__ = ('_path_helper', '_extmethods', '__config','__state','__encapsulate_gre',)
...
the destination addresses within the subnets.
  ...
  _pyangbind_elements = OrderedDict([('config', config), ('state', state), ('encapsulate_gre', encapsulate_gre), ])
