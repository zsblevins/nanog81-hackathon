...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__source_address','__source_flow_label','__destination_address','__destination_flow_label','__dscp','__protocol','__hop_limit',)
...
IPv4 packets, and hop limit in IPv6
  ...
  _pyangbind_elements = OrderedDict([('source_address', source_address), ('source_flow_label', source_flow_label), ('destination_address', destination_address), ('destination_flow_label', destination_flow_label), ('dscp', dscp), ('protocol', protocol), ('hop_limit', hop_limit), ])
