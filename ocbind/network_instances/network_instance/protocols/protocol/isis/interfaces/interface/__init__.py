...
class interface(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__interface_id','__config','__state','__circuit_counters','__authentication','__afi_safi','__levels','__timers','__bfd','__mpls','__interface_ref',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__interface_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="interface-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
  ...
  def _set_interface_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="interface-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
...
features in IS-IS
  ...
  _pyangbind_elements = OrderedDict([('interface_id', interface_id), ('config', config), ('state', state), ('circuit_counters', circuit_counters), ('authentication', authentication), ('afi_safi', afi_safi), ('levels', levels), ('timers', timers), ('bfd', bfd), ('mpls', mpls), ('interface_ref', interface_ref), ])
