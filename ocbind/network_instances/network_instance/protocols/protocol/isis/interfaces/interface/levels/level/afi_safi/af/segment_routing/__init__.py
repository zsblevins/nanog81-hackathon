...
routing for an interface within the IGP.
  """
  __slots__ = ('_path_helper', '_extmethods', '__prefix_sids','__adjacency_sids',)
...
interface.
  ...
  _pyangbind_elements = OrderedDict([('prefix_sids', prefix_sids), ('adjacency_sids', adjacency_sids), ])
