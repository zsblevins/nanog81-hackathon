...
particular level within the IS-IS protocol instance
  """
  __slots__ = ('_path_helper', '_extmethods', '__level_number','__config','__state','__system_level_counters','__link_state_database','__traffic_engineering','__route_preference','__authentication',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__level_number = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="level-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
    ...
    self.__link_state_database = YANGDynClass(base=link_state_database.link_state_database, is_container='container', yang_name="link-state-models", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='container', is_config=True)
  ...
  def _set_level_number(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="level-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
