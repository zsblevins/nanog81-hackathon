...
max-prefixes
  ...
  def _get_restart_timer(self):
    """
    Getter method for restart_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/afi_safis/afi_safi/srte_policy_ipv6/prefix_limit/state/restart_timer (decimal64)
...
the max-prefix limit.
  ...
  def _set_restart_timer(self, v, load=False):
    """
    Setter method for restart_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/afi_safis/afi_safi/srte_policy_ipv6/prefix_limit/state/restart_timer (decimal64)
    If this variable is read-only (config: false) in the
