...
group
  """
  __slots__ = ('_path_helper', '_extmethods', '__connect_retry','__hold_time','__keepalive_interval','__minimum_advertisement_interval',)
...
session with the peer.
  ...
  def _set_connect_retry(self, v, load=False):
    """
    Setter method for connect_retry, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/timers/state/connect_retry (decimal64)
...
set to 3x the keepalive-interval.
  ...
  def _set_hold_time(self, v, load=False):
    """
    Setter method for hold_time, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/timers/state/hold_time (decimal64)
    If this variable is read-only (config: false) in the
...
particular set of NLRI exhibit instability.
  ...
  def _set_minimum_advertisement_interval(self, v, load=False):
    """
    Setter method for minimum_advertisement_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/timers/state/minimum_advertisement_interval (decimal64)
    If this variable is read-only (config: false) in the
