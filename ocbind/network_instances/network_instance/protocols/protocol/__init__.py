...
a particular routing protocol
  """
  __slots__ = ('_path_helper', '_extmethods', '__identifier','__name','__config','__state','__static_routes','__local_aggregates','__bgp','__ospfv2','__isis','__pim','__igmp',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__identifier = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="identifier", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
...
protocol to be instantiated
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="identifier", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
...
information.
  ...
  _pyangbind_elements = OrderedDict([('identifier', identifier), ('name', name), ('config', config), ('state', state), ('static_routes', static_routes), ('local_aggregates', local_aggregates), ('bgp', bgp), ('ospfv2', ospfv2), ('isis', isis), ('pim', pim), ('igmp', igmp), ])
