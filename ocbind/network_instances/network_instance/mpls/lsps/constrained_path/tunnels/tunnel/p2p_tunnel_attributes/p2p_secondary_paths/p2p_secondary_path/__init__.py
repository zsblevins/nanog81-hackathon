...
class p2p_secondary_path(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__config','__state','__admin_groups',)
...
link affinities
  ...
  _pyangbind_elements = OrderedDict([('name', name), ('config', config), ('state', state), ('admin_groups', admin_groups), ])
