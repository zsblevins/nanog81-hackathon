...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__path_computation_method','__use_cspf','__cspf_tiebreaker','__path_computation_server','__explicit_path_name','__preference','__setup_priority','__hold_priority','__retry_timer',)
...
equally desirable paths during CSFP computation
  ...
  def _get_path_computation_server(self):
    """
    Getter method for path_computation_server, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_primary_path/p2p_primary_path/config/path_computation_server (inet:ip-address)
...
server
  ...
  def _set_path_computation_server(self, v, load=False):
    """
    Setter method for path_computation_server, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_primary_path/p2p_primary_path/config/path_computation_server (inet:ip-address)
    If this variable is read-only (config: false) in the
...
server
  ...
  def _set_explicit_path_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="explicit-path-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
