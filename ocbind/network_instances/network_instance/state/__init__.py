...
instance
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__type','__enabled','__description','__router_id','__route_distinguisher','__enabled_address_families','__mtu',)
...
active on the network element
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /network_instances/network_instance/state/enabled (boolean)
    If this variable is read-only (config: false) in the
...
routing information in another network instance
  ...
  def _set_router_id(self, v, load=False):
    """
    Setter method for router_id, mapped from YANG variable /network_instances/network_instance/state/router_id (yang:dotted-quad)
    If this variable is read-only (config: false) in the
...
network instance.
  ...
  def _set_enabled_address_families(self, v, load=False):
    """
    Setter method for enabled_address_families, mapped from YANG variable /network_instances/network_instance/state/enabled_address_families (identityref)
    If this variable is read-only (config: false) in the
...
instance for Layer 2 frames
  ...
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /network_instances/network_instance/state/mtu (uint16)
    If this variable is read-only (config: false) in the
...
instance for Layer 2 frames
  ...
  enabled_address_families = __builtin__.property(_get_enabled_address_families)
