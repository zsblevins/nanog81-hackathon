...
AFT entry.
  """
  __slots__ = ('_path_helper', '_extmethods', '__index','__ip_prefix','__mac_address','__mpls_label','__mpls_tc','__ip_dscp','__ip_protocol','__l4_src_port','__l4_dst_port','__packets_forwarded','__octets_forwarded','__next_hop_group',)
...
within the next-hop group according to the weight.
  ...
  _pyangbind_elements = OrderedDict([('index', index), ('ip_prefix', ip_prefix), ('mac_address', mac_address), ('mpls_label', mpls_label), ('mpls_tc', mpls_tc), ('ip_dscp', ip_dscp), ('ip_protocol', ip_protocol), ('l4_src_port', l4_src_port), ('l4_dst_port', l4_dst_port), ('packets_forwarded', packets_forwarded), ('octets_forwarded', octets_forwarded), ('next_hop_group', next_hop_group), ])
