...
utilise the AFT entry.
  ...
  def _get_packets_forwarded(self):
    """
    Getter method for packets_forwarded, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/state/packets_forwarded (oc-yang:counter64)
...
based on the AFT entry.
  ...
  def _set_packets_forwarded(self, v, load=False):
    """
    Setter method for packets_forwarded, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/state/packets_forwarded (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
based on the AFT entry.
  ...
  def _get_octets_forwarded(self):
    """
    Getter method for octets_forwarded, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/state/octets_forwarded (oc-yang:counter64)
...
based on the AFT entry
  ...
  def _set_octets_forwarded(self, v, load=False):
    """
    Setter method for octets_forwarded, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/state/octets_forwarded (oc-yang:counter64)
    If this variable is read-only (config: false) in the
