...
next-hop entry
  """
  __slots__ = ('_path_helper', '_extmethods', '__index','__ip_address','__mac_address','__pushed_mpls_label_stack','__encapsulate_header','__origin_protocol','__lsp_name',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__lsp_name = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="lsp-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=False)
...
corresponds to the RSVP-TE LSP name.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="lsp-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """lsp_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="lsp-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=False)""",
        })
  ...
  _pyangbind_elements = OrderedDict([('index', index), ('ip_address', ip_address), ('mac_address', mac_address), ('pushed_mpls_label_stack', pushed_mpls_label_stack), ('encapsulate_header', encapsulate_header), ('origin_protocol', origin_protocol), ('lsp_name', lsp_name), ])
